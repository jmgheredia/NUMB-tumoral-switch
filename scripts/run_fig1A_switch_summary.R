...
input_rdata <- file.path("data", "external", "File_S1_switchAnalyzeRlists.Rdata")
...
# -----------------------------
# 2) Compute summary per cancer type
# -----------------------------
cancer_types <- gsub(
  "_cancer",
  "",
...
ggsave(
  filename = file.path(out_dir, "figure1A_switch_summary.tiff"),
  plot = p,
  dpi = 600,
  width = 7, height = 5,
  units = "in",
